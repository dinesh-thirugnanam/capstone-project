      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={[
              ...
              <Picker
                ...
                style={styles.picker}
              >
                <Picker.Item label="Employee" value={USER_ROLES.EMPLOYEE} />
                <Picker.Item label="Administrator" value={USER_ROLES.ADMIN} />
              </Picker>
            </View>
            {formErrors.role && (
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            By creating an account, you agree to use the app responsibly for attendance tracking
          </Text>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
